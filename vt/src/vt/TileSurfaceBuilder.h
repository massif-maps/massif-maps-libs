...
namespace carto::vt {
    ...
    public:
        ...
        void setHeightSkirts(bool heightSkirts);
    ...
    private:
        ...
        static constexpr float SKIRT_DEPTH = 0.05f; // skirt extrusion below the tile minimum height, in tile-local units
