...
namespace carto::vt {
    ...
    public:
        ...
        struct PlacementInfo {
            ...
            std::vector<LabelAnchor> variableAnchors;
            explicit PlacementInfo(int priority, float minimumGroupDistance, bool allowOverlapSameFeatureId, bool sameFeatureIdDependent, std::vector<LabelAnchor> variableAnchors = {}) : priority(priority), minimumGroupDistance(minimumGroupDistance), allowOverlapSameFeatureId(allowOverlapSameFeatureId), sameFeatureIdDependent(sameFeatureIdDependent), variableAnchors(std::move(variableAnchors)) { }
        };
