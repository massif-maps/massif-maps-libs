...
namespace carto::vt {
    ...
    private:
        ...
        static constexpr std::size_t LABEL_ELEVATION_ANCHOR_BUDGET = 64; // max labels re-anchored onto terrain per frame (bounds the render-thread cost on fast zooms)
